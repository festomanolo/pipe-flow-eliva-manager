...
const StatusBadge = ({ status, text, animated = false, className }: StatusBadgeProps) => {
  ...
  const statusClasses = {
    success: "bg-eliva-success/20 text-eliva-success border border-eliva-success/30",
    warning: "bg-eliva-warning/20 text-eliva-warning border border-eliva-warning/30",
    danger: "bg-eliva-danger/20 text-eliva-danger border border-eliva-danger/30",
